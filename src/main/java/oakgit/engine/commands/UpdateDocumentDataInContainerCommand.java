...
public class UpdateDocumentDataInContainerCommand extends AbstractContainerCommand<DocumentEntry> {
  ...
  @NonNull private final DocumentEntryUpdateSet data;

  public UpdateDocumentDataInContainerCommand(
      @NonNull String containerName,
      @NonNull String id,
      long modCount,
      @NonNull DocumentEntryUpdateSet data) {
    super(containerName);
    this.id = id;
  ...
  public ContainerCommandResult<DocumentEntry> buildResult(DocumentEntry updatedEntry) {
    return new SingleEntryResult<>(
        getContainerName(), getEntryType(), updatedEntry, Collections.emptyList());
  }
}
