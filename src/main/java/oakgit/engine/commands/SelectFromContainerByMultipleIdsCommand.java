...
@Getter
public class SelectFromContainerByMultipleIdsCommand<T extends ContainerEntry<T>>
  ...
  public SelectFromContainerByMultipleIdsCommand(
      @NonNull String containerName, @NonNull List<String> ids) {
    super(containerName);
    this.ids = ids;
  }
