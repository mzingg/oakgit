...
@Getter
public class SelectFromContainerByIdCommand<T extends ContainerEntry<T>>
  ...
  public ContainerCommandResult<T> buildResult(ContainerEntry<?> foundEntry) {
    ...
    return new SingleEntryResult<T>(
        getContainerName(), getEntryType(), (T) foundEntry, getResultFieldList());
  }
}
