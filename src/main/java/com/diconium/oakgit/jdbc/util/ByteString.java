/*
 * Taken as is from Avastica Core git://github.com/apache/calcite-avatica.git as this was the only functionality needed.
 */
package com.diconium.oakgit.jdbc.util;
