...
::* default JVM options
if not defined CQ_JVM_OPTS set CQ_JVM_OPTS=-Xmx16g -Djava.awt.headless=true -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:45002
...
set CQ_RUNMODE=%CQ_RUNMODE%,crx3,crx3rdb,samplecontent
